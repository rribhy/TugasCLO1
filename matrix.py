...
k_ndcg = 10
print("\nMengevaluasi algoritma SVD dengan 10-fold cross-validation manual...")
...
print(f"Precision (macro) rata-rata: {precision_hasil:.4f}")
print(f"Recall (macro) rata-rata: {recall_hasil:.4f}")
print(f"F1-score (macro) rata-rata: {f1_hasil:.4f}")
...
plt.title('Hasil Evaluasi Rata-rata Algoritma SVD')
